...
# this code is still included however it is not used as there are no implicit aspects in the 2014 dataset
...
def generate_embeddings(embeddings_layer: EmbeddingsLayer, data: ElementTree, embeddings_dir: str):
    ...
    with torch.inference_mode():
        ...
        for node in tqdm(data.findall('.//sentence'), unit='sentence'):
            ...
            for opinion in node.findall('.//aspectTerm'):
...
def load_ontology():
    ...
    '''
    path = "./data/raw/LaptopManualOntology.owl"
...
def main():
    ...
    #default none
    parser.add_argument("--ont-hops", default=0, type=int, required=False,
