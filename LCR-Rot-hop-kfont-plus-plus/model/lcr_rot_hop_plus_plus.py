...
from .Load_oneEmbedding import generate_OneEmbedding
...
class LCRRotHopPlusPlus(nn.Module):
    def __init__(self, dropout_prob=0.7, output_size=3, input_size=768, hidden_size=300, hops=3, domain: str = "",
        ...
        self.proj1 = nn.Linear(100, 400)
        self.proj2= nn.Linear(100, 400)

    def forward(self, sentence, left_index: int, right_index: int, knowledge_layers,
